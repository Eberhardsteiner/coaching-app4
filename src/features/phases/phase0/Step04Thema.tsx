      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full rounded-md border border-subtle bg-surface px-3 py-2 text-base text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          />
