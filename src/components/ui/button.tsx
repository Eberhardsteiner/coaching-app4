...
/**
 * Button — shadcn/ui pattern (CVA variants + Radix `Slot` for `asChild`),
 * wired to the project design tokens instead of shadcn's default palette.
 */
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border border-subtle bg-surface text-foreground hover:bg-surface-2",
        outline:
          "border border-subtle bg-background text-foreground hover:bg-surface",
